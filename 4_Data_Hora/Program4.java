...
/**
 * Somar e subtrair tempo de uma data
 * Calcular a diferença de tempo de uma data para outra
 */
public class Program4 {
	...
	public static void main(String[] args) {
		...
		LocalDate nextWeekDate = d04.plusDays(7).plusYears(1);
        ...
        // para calcular a diferença de duas LocalDate, tem que usar o atStartOfDay()
		...
		Duration t3 = Duration.between(pastWeekInstant, d06); //  7
		Duration t4 = Duration.between(d06, pastWeekInstant); // -7
